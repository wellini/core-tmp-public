...
public class EnrollInCourseOperation extends Operation<EnrollInCourseCommand> {
    ...
    public EnrollInCourseOperation(OperationExecutionContextFactory contextFactory, UserService userService, CourseAffiliationService courseAffiliationService, CourseRepository courseRepository) {
    ...
    @Override
    @Transactional
    protected ExplainedExecResult doExecute(AbstractOperationExecutionContext context, EnrollInCourseCommand command) {
