package io.roadmaps.core.integrations.web.rest.api.leaf.dtos;

import io.roadmaps.core.domain.model.leaf.Leaf;
import io.roadmaps.core.domain.model.leaf.LinkLeaf;
...
public class GetLeafResponse {
    ...
    private GetLeafResponse(Long id, String title, LeafType type, Integer orderId, LeafData data, Long moduleId) {
        this.id = id;
        this.title = title;
        this.type = type;
